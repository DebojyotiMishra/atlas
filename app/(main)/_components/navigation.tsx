  ...
  return (
    <div>
      ...
      >
        ...
        <div className="opacity-0 group-hover/sidebar:opacity-70 transition cursor-ew-resize absolute h-full w-0.5 bg-primary/10 right-0 top-0"></div>
      </aside>
      <div
        ref={navbarRef}
        className={cn(
          "absolute top-0 left-60 z-[99999] flex items-center w-[calc(100%-240px)]",
          isResetting && "transition-all ease-in-out duration-300",
